...
If you have little or no experience with Python, we highly recommend switching over to Getting Started with Python Tutorial before working through this tutorial https://www.master--hungry-liskov-0501e4.netlify.com/doc-python/getting_started_with_python/[here].
