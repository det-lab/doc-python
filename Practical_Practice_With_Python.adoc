...
If you have little or no experience with Python, we highly recommend switching over to Getting Started with Python Tutorial before working through this tutorial link:_includes/user/karl/doc-python/Getting_Started_With_Python.adoc[here].
